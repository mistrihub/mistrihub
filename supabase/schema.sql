...
values
  ...
  ('Carpenter Interior & Decorator', 'carpenter', 'Furniture, interiors, decor work, fittings, doors, and custom woodwork'),
  ('Mechanic Bike/Auto', 'mechanic', 'Bike, auto, two-wheeler inspection, repair, and servicing'),
  ('Painter Putty/POP', 'painter', 'Painting, wall putty, POP, texture, polish, and touch-up work'),
  ('AC/Cooler/Fridge/Washing Machine Repair', 'ac-repair', 'AC, cooler, fridge, and washing machine service or repair'),
  ...
  ('Graphic/Web Designer', 'graphic-web-designer', 'Logo, banner, poster, website design, and digital creative work')
