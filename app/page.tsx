      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1.65fr)_320px] lg:items-center lg:px-8 lg:py-16">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">Search electricians, plumbers, drivers, carpenters, mechanics, painters, and AC repair technicians. Compare profiles and contact directly. Fully free, no hidden cost.</p>
            <div className="mt-8">
              <Suspense>
                <SearchForm />
              </Suspense>
